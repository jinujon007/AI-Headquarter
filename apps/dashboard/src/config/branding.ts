...
export const BRANDING = {
  ...
  agentName: process.env.NEXT_PUBLIC_AGENT_NAME || "AI HQ",
  ...
  companyName: process.env.NEXT_PUBLIC_COMPANY_NAME || "AI HEADQUARTERS",

  // App title (shown in browser tab)
  appTitle: process.env.NEXT_PUBLIC_APP_TITLE || "AI HQ",
} as const;
