    ...
    <div className="p-4 md:p-8">
      ...
      <div className="mb-4 md:mb-6">
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>
          Overview of AI HQ agent activity
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        >
          ...
          <div className="p-4 grid grid-cols-2 gap-2">
            {[
              { href: "/office", icon: Gamepad2, label: "3D Office", color: "var(--accent)" },
              { href: "/agents", icon: Users, label: "Agents", color: "#a78bfa" },
              { href: "/system", icon: Server, label: "System", color: "var(--success)" },
              { href: "/logs", icon: Terminal, label: "Live Logs", color: "#60a5fa" },
              { href: "/costs", icon: Zap, label: "Costs", color: "#f59e0b" },
              { href: "/settings", icon: Brain, label: "Settings", color: "#4ade80" },
          ...
          {ws.messages.length > 0 && (
            <div className="mx-4 mb-4">
              ...
              <div className="space-y-1.5">
                {ws.messages.slice(0, 4).map((msg, i) => (
                  <div
                    key={i}
                    className="text-xs p-2 rounded"
                    style={{ backgroundColor: 'var(--card-elevated)', color: 'var(--text-secondary)' }}
                  >
                    <span className="font-semibold" style={{ color: 'var(--accent)' }}>{msg.agentId}</span>
                    {' · '}
