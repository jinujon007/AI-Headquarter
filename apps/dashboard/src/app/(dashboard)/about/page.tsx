...
export default function AboutPage() {
  ...
  useEffect(() => {
    Promise.all([
    ...
    ]).then(([activities, agentsData, tasks]) => {
      ...
      setStats({
        ...
        skillsCount: agentsData.agents?.length || 0,
  ...
  const description =
    ...
    `AI assistant for ${ownerUsername}. Powered by AI HQ.`;
        ...
        >
          ...
          >
            <p>
              ...
              <span style={{ color: "var(--accent)" }}>AI HQ</span> with
              Ollama as my brain.
            </p>
            <p>
      ...
      >
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          >
            ...
            <a
              href="https://github.com/harishkotra/agent-office"
              target="_blank"
